...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0, _slider.initSwiperCoach)();
  (0, _slider.initSwiperReview)();
  (0, _video.findVideos)();
...
},{"./modules/form-validate/form":3,"./modules/slider/slider":9,"./modules/tabs/init-tabs":10,"./modules/video":12,"./utils/ios-vh-fix":14}],2:[function(require,module,exports){
"use strict";
...
exports.initSwiperReview = exports.initSwiperCoach = void 0;
var swiperCoach = document.querySelector('.coaches__wrapper');
var initSwiperCoach = function initSwiperCoach() {
  if (swiperCoach) {
    (function () {
      return new Swiper('.coaches__wrapper', {
        // eslint-disable-line
...
exports.initSwiperCoach = initSwiperCoach;
var swiperReview = document.querySelector('.reviews__wrapper');
var initSwiperReview = function initSwiperReview() {
  if (swiperReview) {
    (function () {
      return new Swiper('.reviews__wrapper', {
        // eslint-disable-line
        direction: 'horizontal',
        loop: false,
        navigation: {
...
exports.initSwiperReview = initSwiperReview;
...
var createIframe = function createIframe() {
  ...
  var source = 'https://www.youtube.com/embed/9TZXsZItgdw?rel=0&showinfo=0&autoplay=1';
